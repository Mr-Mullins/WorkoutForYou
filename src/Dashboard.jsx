...
export default function Dashboard({ session }) {
  ...
  const exercises = [
    {
      id: 1,
      title: "1. Liggende Bekkenvipp",
      desc: "10-15 repetisjoner. Stram magen, press ryggen ned.",
    },
    {
      id: 2,
      title: "2. Barnets stilling",
      desc: "Hold 30-60 sek. Pass på kneprotesen.",
    },
    {
      id: 3,
      title: "3. Tøy hofteleddsbøyer",
      desc: "30 sek per side. Ikke svai i ryggen.",
    },
    {
      id: 4,
      title: "4. Fuglehunden",
      desc: "3 x 10 reps. Løft lavt og kontrollert.",
    },
    {
      id: 5,
      title: "5. Seteløft",
      desc: "3 x 10 reps. Stopp når kroppen er rett.",
    },
  ];
